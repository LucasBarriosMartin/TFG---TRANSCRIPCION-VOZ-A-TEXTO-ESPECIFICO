...
- En la aplicación Android:
  ...
  - Crear el panel de configuración ✅ Dia 03/04/2026
  - Implementar el Speech-Recognition (SherpaOnnx) en el modo offline, es decir, que pueda reconocer las voces de quien esté hablando.
  - Consultar con los tutores el color de los botones dependiendo de la configuración
